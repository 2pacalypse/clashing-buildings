...
def _run_chain_overlap_benchmark(
    benchmark, num_buildings, detector_cls, expected_clashes
):
    """
...
@pytest.mark.parametrize(
    "num_buildings,detector_cls,expected_clashes",
    [
